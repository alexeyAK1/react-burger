...
import { useBurgerConstructorState } from './hooks/use-burger-constructor-state';

function BurgerConstructor() {
  const { isOpenModal, onOpenModal, onCloseModal } = useToggleModal();
  const state = useBurgerConstructorState();
  const { bun, ingredients, order, totalSum, setOrder } = state;
  ...
  return (
    <BurgerConstructorContextProvider value={state}>
    ...
    </BurgerConstructorContextProvider>
  );
}
